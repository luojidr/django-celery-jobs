...
from .fields import MIN_VALUES, MAX_VALUES
...
class RangeExpression(AllExpression):
    """ first, first-last, first/step, first-last/step """
...
class YearRangeExpression(RangeExpression):
    value_re = re.compile(r'last', re.IGNORECASE)

    def __init__(self):
        super(YearRangeExpression, self).__init__(None)
